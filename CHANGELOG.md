...
- Add Stream Profiles (Auto/Realtime/Install) that compile into deterministic `config_id`s and cannot change once streaming starts, exposing selection via `client.start_stream`.
